...
export function ActivityCard({ activity, status, onToggleStatus, onSelect, onRemove }: ActivityCardProps) {
  return (
    <div
      className="bg-white rounded-xl shadow-sm border border-alpine-200 p-4 hover:shadow-md transition-shadow cursor-pointer"
      onClick={onSelect}
    >
      <div className="flex items-start justify-between gap-3">
        <div className="flex items-start gap-3 min-w-0">
          <span className="text-2xl shrink-0 mt-0.5">{activity.imageEmoji}</span>
